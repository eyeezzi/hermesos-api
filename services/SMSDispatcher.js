...
function periodicallyDispatchSMS() {
	...
	async function processJobs() {
		console.log(`[${new Date().toISOString()}] [cron] [processJobs]`)

		try {
			const db = await connectToDB(DB_URL)
	...
	cron.schedule(SCHEDULE, processJobs)
}

module.exports = periodicallyDispatchSMS
